...
export  const AddEditIncident:FC<IAddEditIncident> = ({edit,formData,modal,toggle,fetchAllData}) =>{
    const {
        register,
        handleSubmit,
        reset,
    ...
    const onSubmit = async(data:any) =>{
        ...
        //   delete newData?.id
        //   setLoading(true)
        //   let text = edit ? "Incident Updated" : "Incident Added";
        //   try {
        //     let res;
        //     if (edit) {
    ...
    return (
      ...
      >
        <DialogTitle id="alert-dialog-title">{edit ? "Edit Incident": "Add Incident"}</DialogTitle>
